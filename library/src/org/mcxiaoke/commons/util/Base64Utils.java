...
public class Base64Utils {
	 ...
	 * Otherwise {@link Base64#encodeBytesToBytes(byte[])}
	 * is used.
	 ...
	 * Otherwise {@link Base64#encodeBytes(byte[])}
	 * is used.
	 * @param input the byte array to encode
	 ...
	 * Otherwise {@link Base64#decode(byte[])}
	 * is used.
	 ...
	 * Otherwise {@link Base64#decode(String)}
	 * is used.
